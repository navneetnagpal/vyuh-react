...
export const Section: React.FC<SectionProps> = ({
  ...
  const paddingClasses = {
    none: '',
    sm: 'px-6 py-8 sm:px-8 sm:py-12',
    md: 'px-8 py-12 sm:px-12 sm:py-16',
    lg: 'px-8 py-16 sm:px-12 md:px-16 sm:py-24',
    xl: 'px-10 py-24 sm:px-16 md:px-20 sm:py-32',
  };
  ...
  return (
    <Component
      className={cn(paddingClasses[padding], backgroundClasses, className)}
