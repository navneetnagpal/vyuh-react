...
/**
 * Dummy JSON API schema for Sanity
 *
 * This schema provides options for:
 * - Selecting the API type (products or search)
 * - Specifying the search text (when type is search)
 * - Setting the limit and skip parameters for pagination
 */
